...
sudo apt-get install --yes net-tools build-essential zsh neofetch htop curl wget zip unzip sed mc micro python3 python3-pip httpie git gpg tmux nano vim locales || {
